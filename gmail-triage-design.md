...
`logs/triage_YYYYMMDD_HHMM.log` に以下を記録:

```
2026-04-17 07:00:01 [INFO] 開始: 直近24時間の未読メール取得
2026-04-17 07:00:02 [INFO] 取得: 19通
2026-04-17 07:00:05 [INFO] Claude 分類完了: important=1, review=1, keep=5, delete=12
2026-04-17 07:00:06 [INFO] 削除: 12通をゴミ箱に移動
2026-04-17 07:00:07 [INFO] Discord通知: 送信完了
2026-04-17 07:00:07 [INFO] 完了
```

エラー時は `[ERROR]` レベルで記録し、Discord にもエラー通知を送る。
